...
import { FormsHoc, FormFillsHoc, FormFillPageWrapper, ConstructorHoc } from 'containers';
...
const Routes = ({ currRole }) => (
  <Switch>
    ...
    {checkAccess(currRole, guestRole) && <Route path="/forms/active/:id" component={FormFillPageWrapper}/>}
